#__마크 저커버그__가 직접 만들어 본 AI 비서 '자비스'
...
#GPT-4 발표한 오픈AI __'샘 알트만'__, AI가 사회를 재구성할 것이며 위험을 인정합니다, 이것이 조금 두렵습니다


##AI가 일자리를 대체할 것인가? 에 대해서 __알트만__은 이것이 가까운 장래에 일부 일자리를 대체할 가능성이 있으며 얼마나 빨리 일어날 수 있는지 걱정하고 있다고 밝혔다.
...
====================================================================================
처음 사용하는 툴이라 사용하는 것이 조금 시간이 걸렸고 완전히 능숙해지진 않았지만 툴을 사용해봤던 팀원에게 물어보고 퍼실님께서 추천해주신 gpt로 해결해가면서 교육받는 것이 좀 더 수월해졌다. 질문은 최대한 gpt로 해결하고 팀원에게 질문하려고 했고 도움이 많이 되었다.
